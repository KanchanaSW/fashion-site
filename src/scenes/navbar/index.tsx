...
const Navbar = ({ selectedPage, setSelectedPage, isTopOfPage }: Props) => {
    ...
    const navbarBackground = isTopOfPage ? "" : "bg-white drop-shadow border-solid border-b-2 border-gray-100";
                ...
                <div className={`${flexBetween} mx-auto w-5/6`}>
                    <div className={`${flexBetween} w-full gap-16`}>
                        ...
                        {isAboveMediumScreens ? (
                            ...
                            <button className="rounded-full bg-[#EBD96B] p-2" onClick={() => setIsMenuToggled(!isMenuToggled)}>
